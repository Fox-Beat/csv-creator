...
export const INPUT_HEADER_MAPPINGS = {
  ...
  GAMELABELS_RISING_STAR: "gameLabelsData_RisingStar",
...
export const OUTPUT_CSV_COLUMNS: (keyof ProcessedGameData | 'gameLabelsData_Drops and Wins')[] = [
  'gameCode',
  'name',
  'isActive',
  'mobileGameCode',
